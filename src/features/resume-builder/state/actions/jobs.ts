...
export type JobActionType = "add-job"|
  "remove-job"|
  "update-job"|
  "date-changed-job"|
  "name-changed-job";
...
export const isRemoveJobAction = (action: JobAction): action is RemoveJobAction => {
  return action.type === "remove-job";
}

export const isJobDateChangedAction = (action: JobAction): action is JobDateChangedAction => {
  return action.type === "date-changed-job";
}

export const isJobNameChangeAction = (action: JobAction): action is JobNameChangedAction => {
  return action.type === "named-changed-job";
}
